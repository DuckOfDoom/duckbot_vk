...
help = string "/help" <|> string "/?" >>
  pure (\userId -> VK.sendMessage userId $ 
    Utils.joinText "\n" 
      ...
      , "   Просто набери имя ноты, а через пробел первые три или больше первых букв названия нужного тебе лада (латиницей)."
      ...
      , "   ВНИМАНИЕ: Сообщения от бота могут быть слишком длинными и тогда будут обрезаны"
      ]
    )